                ...
                <div class="modal-dialog" role="document"><!-- modal-dialog -->
                    <div class="modal-content"><!-- modal-content -->
                        ...
                        <div class="modal-body">
                            ...
                            <p><input type="text" id="addItem" placeholder="Enter your content (Max 100 Char) ..." class="form-control"></p>
                            <p><input type="checkbox" id="setItem" class="form-control"> Mark as done </p>
                        </div>
